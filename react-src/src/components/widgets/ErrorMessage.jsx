...
const ChatbotMessageWithError = ( {state, message} ) => {
...
return (
    <div className="react-chatbot-kit-chat-bot-custom-message-container" >
        ...
        <div className="react-chatbot-kit-chat-bot-custom-message" style={{ backgroundColor: 'lightcoral' }}>
...
export default ChatbotMessageWithError;
